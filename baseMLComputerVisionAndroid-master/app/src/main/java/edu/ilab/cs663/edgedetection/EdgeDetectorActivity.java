...
package edu.ilab.cs663.edgedetection;
...
import edu.ilab.cs663.edgedetection.customview.OverlayView;
import edu.ilab.cs663.edgedetection.customview.OverlayView.DrawCallback;
import edu.ilab.cs663.edgedetection.tflite.Classifier;
import edu.ilab.cs663.edgedetection.env.Logger;
import edu.ilab.cs663.edgedetection.env.ImageUtils;
import edu.ilab.cs663.edgedetection.env.BorderedText;
import edu.ilab.cs663.edgedetection.tracking.MultiBoxTracker;
import edu.ilab.cs663.edgedetection.tflite.TFLiteObjectDetectionAPIModel;
...
//                            }
    ...
    private void processImage(Canvas canvas) {
		...
		Log.d("Original",bmp32.toString());

		// PUT YOUR OPENCV CODE HERE
		// INPUT: bmp32 
		// OUTPUT: bmp32 (after processing)
		mat = new Mat(bmp32.getWidth(),bmp32.getHeight(),CvType.CV_8UC1);
