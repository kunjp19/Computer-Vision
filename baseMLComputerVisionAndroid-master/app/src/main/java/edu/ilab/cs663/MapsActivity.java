...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
     ...
     */
    DetectorActivity exampleEdgeDetectorActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edgeDetectorButton = findViewById(R.id.IPButton);
        edgeDetectorButton.setOnClickListener(view->{
            Intent intent = new Intent("edu.ilab.cs663.edgedetection.EdgeDetectorActivity");
            startActivity(intent);
        });
